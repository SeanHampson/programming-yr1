/*Simple Maths Quiz Game
    ...
    Author: Seán Hampson
    Date: 22-10-2019(everything structured apart from case 2), 
             23-10-2019(worked on case 2, cleaned up UI)
    Compiler: Borland
    OS: Windows 10
*/
#include <stdio.h>
        ...
        switch(select)
        {
            ...
            {   
                ...
                else //otherwise force user to set a number in the menu
                {
                    //clears screen-looks cleaner
                    system("@cls||clear");
                    printf("[?]Please set the number of questions to be asked first!\n\n");
                }
